...
execute as @e[tag=lamp,nbt={item:{components:{"minecraft:custom_model_data":{strings:["lamp1_disabled"]}}}}] at @s run function f:missions/tutorial/visuals/as_lamp
execute as @e[tag=lamp,nbt={item:{components:{"minecraft:custom_model_data":{strings:["lamp1_enabled"]}}}}] at @s run function f:missions/tutorial/visuals/as_lamp